...
Covers backend selection, model health/fallback, usage, and lifecycle regressions.
...
| `test_proxy_model_extraction.py` | regression | Verify model extraction, model health tracking, and model fallback behavior |
