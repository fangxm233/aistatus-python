# input: provider configs, concrete adapter subclasses, and registry lookups by adapter type
# output: common provider adapter interface, optional streaming hooks, and adapter factory registration
# pos: abstraction layer that standardizes provider behavior for router-managed sync and async calls
